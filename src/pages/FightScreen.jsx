      ...
      const validateFighter = (fighter) => {
        return {
          ...
          Rating: {
            ...
            handSpeed: Number(fighter.Rating.striking) || 0,
            headMovement: Number(fighter.Rating.striking) || 0,
            punchAccuracy: Number(fighter.Rating.striking) || 0,
            kicking: Number(fighter.Rating.kicking) || 0,
            kickSpeed: Number(fighter.Rating.kicking) || 0,
            footwork: Number(fighter.Rating.kicking) || 0,
            kickAccuracy: Number(fighter.Rating.kicking) || 0,
