      ...
      const validateFighter = (fighter) => {
        return {
          ...
          stats: {
            ...
            clinchEntered: Number(fighter.stats.clinchEntered) || 0,
            clinchExits: Number(fighter.stats.clinchExits) || 0,
            ...
            clinchTakedownsAttempted: Number(fighter.stats.clinchTakedownsAttempted) || 0,
            clinchTakedownsSuccessful: Number(fighter.stats.clinchTakedownsSuccessful) || 0,
            clinchTakedownsDefended: Number(fighter.stats.clinchTakedownsDefended) || 0,
